...
embed_url("https://www.youtube.com/watch?v=lMY2t4SQ0Pg")
```
...
embed_url("https://www.youtube.com/watch?v=NwwlB6Lp1TY")
```
...
embed_url("https://www.youtube.com/watch?v=6EdllKtaDHE")
```
...
embed_url("https://www.youtube.com/watch?v=c9DZ8lBwxZs")
```
...
There is a package in R that helps make this process easier when you want to summarize several variables at a time. It is called `dataReporter`. Documentation is available [here](https://github.com/ekstroem/dataReporter).
