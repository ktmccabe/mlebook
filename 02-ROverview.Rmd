...
R Studio has its own set of primers on various topics, including summarizing and working with data. See the [Work with Data](https://rstudio.cloud/learn/primers/2) primer, as well as the full list of other [topics](https://rstudio.cloud/learn/primers).
