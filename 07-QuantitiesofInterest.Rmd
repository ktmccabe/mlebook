...
Here is a brief video with a second example of the process above, leading into the discussion of marginal effects below. It uses the [anes data](https://raw.githubusercontent.com/ktmccabe/teachingdata/main/anesdems.csv) from Banda and Cassese in section 6.

```{r, echo=FALSE, warning=FALSE, message=FALSE}
library("vembedr")
library(knitr)

embed_url("https://www.youtube.com/watch?v=vGt-OCJoCJQ")
```
...
Beyond this simple case, there are three general approaches to calculating the uncertainty of the quantities of interest. Here is a video with an overview of these three processes. The course notes contain additional detail below. It continues with the [anes data](https://raw.githubusercontent.com/ktmccabe/teachingdata/main/anesdems.csv) example from Banda and Cassese in section 6, as did the other video in this section.

```{r, echo=FALSE, warning=FALSE, message=FALSE}
library("vembedr")
library(knitr)

embed_url("https://www.youtube.com/watch?v=BYE4TWV6Byc")
```
...
<details> <summary>Try on your own, then expand for one solution.</summary>
...
<details> <summary>Computing probabilities.</summary>
...
library(knitr)
knitr::kable(summary(pred.results))
...
<details> <summary>Bootstrap Details </summary>
