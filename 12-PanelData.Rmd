...
These are some supplemental resources
  ...
  - Nathaniel Beck and Jonathan Katz. "Time-Series–Cross-Section Issues: Dynamics, 2004." [here](http://www.nyu.edu/gsas/dept/politics/faculty/beck/beckkatz.pdf). Related papers:
...
Textbook Resources for Multilevel Data:

  - Bradford Jones.Available [here](http://psfaculty.ucdavis.edu/bsjjones/oxfordML.pdf)
...
We think there may be $c_i$ unobserved characteristics about our units $i$ that are related to our explanators and our outcomes. If unaccounted for and left as part of the error term, this would cause bias in our coefficients. 
...
where $\alpha_{i}$ is unobserved, time-invariant characteristic for unit $i$ (e.g., features of geography, culture, etc.)
